SiteTrust Checker Worker Fixed V5

এই ভার্সনে worker.js syntax error fix করা হয়েছে। Cloudflare build failed হলে আগের package বাদ দিয়ে এই package upload করুন।
